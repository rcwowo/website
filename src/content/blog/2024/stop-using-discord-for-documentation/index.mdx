...
![A screenshot of an invite page for a Discord server. The page displays that you were invited to "Lt. Wilscord" and are prompted to login or create an account.](./assets/discord-invite.png)
...
![The Astro Docs website with the sidebar on the left, page content on the right, and a table of contents labelled "On this page" on the right.](./assets/astro-docs.png)
