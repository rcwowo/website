...
![A chart labelled “Desktop Operating System Market Share Worldwide” in the past year. On the x-axis are the dates beginning with August 2023, and ending in August 2024. On the y-axis is the percentage of market each operating system occupies. As of today, Windows maintains 71%, macOS maintains 15%, Linux maintains 4%, and chromeOS maintains 2%.](https://utfs.io/f/1HXxpZGmqtvTBDpSCRcugp5C9BLJoyq2wKbhcnxZjTdkiR0H)
...
|---|---|
|![The Windows 8 desktop, which notably is missing the iconic “Start” button in the bottom taskbar.](https://utfs.io/f/1HXxpZGmqtvT3pQrJFSyLpF5wgUXBiHa8letYNS6bvI7drZ0)|![The Windows 8 start menu, which takes up the entire screen and uses a large tile-like grid to display apps.](https://utfs.io/f/1HXxpZGmqtvTrZwVL4phMjOvsfX59ntkaLcJmlRG7CdubqNV)|
...
|---|---|
|![The Windows 10 start menu with a bunch of preinstalled apps like Office, Candy Crush Saga, Minecraft, and others.](https://utfs.io/f/1HXxpZGmqtvTrmlLAShMjOvsfX59ntkaLcJmlRG7CdubqNV6)|![The original Microsoft Edge icon in the Windows 10 taskbar with a tooltip labelled “Wanna earn while you browse?” and the subtext “Get free movies and games with Microsoft Edge. See how.”](https://utfs.io/f/1HXxpZGmqtvTRRWDnOw32g5NQSZfw1Y7lCPsoebaEFBU6jIW)|
...
![A user interface for the Windows Recall app, which displays a search box with the pre-filled in text “Korean restaurant that Alice”. The app displays multiple images of screenshots that pertain to this search.](https://utfs.io/f/1HXxpZGmqtvTO72vhgxH20xQA6SI4MBsnC3qu8YUawNyVhmg)
...
![A view of a computer's desktop, with the app “Software Manager” displayed in the center. The app window contains a banner for the featured “Firefox” app, as well as a grid of different app icons. At the bottom of the window is another grid of app categories.](https://utfs.io/f/1HXxpZGmqtvTeCSykQlP8QV672MnzbrkTNGEBHCAo9l0J1aL)
...
![A screen capture of VLC media player, displaying a tab titled “Codec” that has 2 dropdown items, “Stream 0” and “Stream 1” with Stream 0 being H264, and Stream 1 being AAC.](https://utfs.io/f/1HXxpZGmqtvT0ZBTwIFc41MjBRCwApLda5NelvKktQobsITV)
