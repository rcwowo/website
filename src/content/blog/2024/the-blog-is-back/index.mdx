...
Also, you've probably already seen, but I have migrated the few posts from my old blog to here. Like the wonderful [lag mitigation](../minecraft/migrating-and-mitigating-lag/) fiasco that I did not need to write, but still documented anyway.
